...
namespace Space_Buns_Ordering_System
{
    public partial class sb_checkout : System.Web.UI.Page
    {
        ...
        {
            // on click need to add the cart db for the current user into the order details db (need to rename) and delete those item in the cart that belong to the currentuser
            // get customer id based on the current user
            String currentUser = lblCustId.Text;
            ...
            // get customer id
            string delCartQuery = "";
            SqlCommand cmdDelCart = new SqlCommand(delCartQuery, con);
            cmdDelCart.Parameters.AddWithValue("@customerName", currentUser);
            var delCart = cmdDelCart.ExecuteNonQuery();
