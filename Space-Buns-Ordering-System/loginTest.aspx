<%@ Page Title="" Language="C#" MasterPageFile="~/sb_master.Master" AutoEventWireup="true" CodeBehind="loginTest.aspx.cs" Inherits="Space_Buns_Ordering_System.loginTest" %>
        ...
        <fieldset
            ...
            <div class="auto-style1">
                <asp:Login ID="Login1" runat="server" Width="100%">
                    <LayoutTemplate>
                        <table cellpadding="1" cellspacing="0" style="border-collapse: collapse;" style="width: 100px" align="center">
                            <tr>
                                <td class="auto-style5">
                                    <table cellpadding="0" class="auto-style4">
                                        ...
                                        <tr>
                                            <td align="center" style="color: Red;" class="auto-style7">
