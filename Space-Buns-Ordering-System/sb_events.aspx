<%@ Page Title="Events | Space Buns" Language="C#" MasterPageFile="~/sb_master.Master" AutoEventWireup="true" CodeBehind="sb_events.aspx.cs" Inherits="Space_Buns_Ordering_System.sb_events" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="CSS/sb_events.css">
    ...
    <div class="events-container">
        <section class="eventsTitle sec-width" id="eventsTitle">
            <div class="title">
                ...
                <p>
                    it'll take more than crafting the perfect food and drink menu to arrange the perfect private
                    event.
                </p>
        ...
        <section>
            ...
            <article class="events">
                ...
                <div class="events-text">
                    ...
                    <p>
                        Sometimes it's just around the corner, other times you have to travel the world in search of
                        it.
                    </p>
