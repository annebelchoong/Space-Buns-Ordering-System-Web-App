        ...
        <fieldset
            ...
            <div>
             ...
             <div>
                 ...
                 <br />
                 <br />
                 <asp:HyperLink ID="forgetPwLink" runat="server" NavigateUrl="sb_forgotPassword.aspx">Forget Password</asp:HyperLink>
                 <br />
                 <br />Not a member?
                 <asp:HyperLink ID="lnkRegister" runat="server" NavigateUrl="sb_registration.aspx">Sign Up</asp:HyperLink>
                 <br />
                 <br />
                 <br />
                 <br />
