<%@ Page Title="" Language="C#" MasterPageFile="~/UserProfile/sb_masterProfile.Master" AutoEventWireup="true" CodeBehind="sb_updatePassword.aspx.cs" Inherits="Space_Buns_Ordering_System.UserProfile.sb_updatePassword" %>
        ...
        <div class="overview">
            ...
            <div>
                <table style="width: 80%;">
                    ...
                    <tr>
                        <td class="auto-style2">
                            <asp:TextBox ID="txtNewPassword" runat="server" class="input" placeholder="Password"></asp:TextBox>
                        </td>
                        <td class="auto-style5">&nbsp;</td>
                    </tr>
                    <tr>
