        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <br />
                    <asp:Button ID="btnUpdateProfile" runat="server" class="userProfileButtons" Text="Update Profile" PostBackUrl="sb_updateProfile.aspx" OnClick="btnUpdateProfile_Click" />
                    <asp:Button ID="btnChangePassword" runat="server" class="userProfileButtons" Text="Change Password" PostBackUrl="sb_updatePassword.aspx" />
                    <br />
                </div>
                <strong>
