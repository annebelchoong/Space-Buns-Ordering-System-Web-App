         ...
         <fieldset
            ...
            <div>
             ...
             <div>
                 ...
                 <br />
                 <asp:RegularExpressionValidator ID="regexPhoneNo" runat="server" ErrorMessage="Invalid phone number!" ControlToValidate="txtPhoneNo" ValidationExpression="^[0-9]{10}$" ForeColor="#CC0000" ValidationGroup="SignUp">*</asp:RegularExpressionValidator>
                 <br />
                 <br />
                 ...
                 <asp:CustomValidator ID="chkSignUpCustomValidator" runat="server"
                        ...
                        ValidateEmptyText="true" ForeColor="#CC0000" ToolTip="You must accept the terms and conditions to sign up" ValidationGroup="SignUp">*</asp:CustomValidator>
                 ...
                 <br />
                 <br />
                 <asp:ValidationSummary ID="SignUpValidSummary" runat="server" DisplayMode="List" ForeColor="#CC0000" ValidationGroup="SignUp" />
                 <br />
             </div>
         </fieldset>
    </form>
